...
export function router() {
  ...
  const routes = {
    ...
    "/my-activity-on-listings/bid-history": {
      ...
      init: async () => {
        const { initBidHistory } = await import(
          "../views/my-activity-on-listings/bidHistory.mjs"
        );
        initBidHistory();
      },
    },
    "/my-activity-on-listings/wishlist-and-active-bids": {
      template:
        "/templates/my-activity-on-listings/wishlist-and-active-bids.html",
      title: "Wishlist and active bids | " + pageTitle,
      description: "View your wishlist and active bids at Auction House.",
      init: async () => {
        const { initWishlistAndBids } = await import(
          "../views/my-activity-on-listings/wishlistAndBids.mjs"
        );
        initWishlistAndBids();
      },
    },
    ...
    "/my-listings/inactive": {
      ...
      init: async () => {
        const { initInactive } = await import(
          "../views/my-listings/inactive.mjs"
        );
        initInactive();
      },
    },
    "/my-profile/read": {
      ...
      init: async () => {
        const { initReadMyProfile } = await import(
          "../views/my-profile/read.mjs"
        );
        initReadMyProfile();
      },
    },
    "/my-profile/update": {
      ...
      init: async () => {
        const { initUpdateProfile } = await import(
          "../views/my-profile/update.mjs"
        );
        initUpdateProfile();
      },
    },
